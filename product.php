					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="add-product-form" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="soluongban">Số Lượng</label>
									<input type="text" class="form-control" name="soluongban" id="soluongban">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="speed" id="speed"></textarea>
								</div>
								<div class="form-group">
					...
					<div class="modal-content">
						...
						<form id="update-product-form" method="POST" action="<?php echo $_SERVER["PHP_SELF"] ?>">
							<div class="modal-body">
								...
								<div class="form-group">
									<label for="soluongban">Số Lượng</label>
									<input type="text" class="form-control" name="soluongban" id="usoluongban">
								</div>
								<div class="form-group">
									<label for="description">Description</label>
								...
								<div class="form-group">
									<label for="speed">Speed</label>
									<input type='text' class="form-control" name="speed" id="uspeed">
								</div>
								<div class="form-group">
									<label for="category">Category</label>
								...
								<div class="form-group">
									<label for="loai">Loại</label>
									<select class="form-control" name="loai" id="uloai">
									</select>
